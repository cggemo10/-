package com.rrja.cja.view.recycler.stickyside;
...
public class LayoutManager extends RecyclerView.LayoutManager {
     ...
     *
     * @param key Key to match that to be set in {@link LayoutManager.LayoutParams#setSlm(String)}.
...
//            attachView(header, findLastIndexForSection(sd.firstPosition) + 1);
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        /**
         * Creates a new instance of {@link LayoutManager.LayoutParams}.
         *
         * @param other Source layout params.
